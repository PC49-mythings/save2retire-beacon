          ...
          <div className="chart-card">
            ...
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={anxOptTrend}>
                ...
                <Line type="monotone" dataKey="anxiety"      name="Anxiety (T04)"                stroke="#ef4444" strokeWidth={2.5} dot={{ r: 4, fill: "#ef4444" }} />
                <Line type="monotone" dataKey="optimisation" name="Optimisation (T01+T06+T07)"   stroke="#10b981" strokeWidth={2.5} dot={{ r: 4, fill: "#10b981" }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
